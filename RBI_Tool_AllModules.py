...
class Tier_1_Indicator_Tool (object):
    ...
    #Define IN/OUT parameters
        ...
        serviceLst=["Reduced Flood Risk", "Scenic Views", "Environmental Education", "Bird Watching", "Recreation", "Social Equity", "Reliability"]
        ...
        rel = setParam(serviceLst[5], "rel", "GPBoolean", "Optional", "")
        check_box_list = [flood, view, edu, bird, rec, socEq, rel]
...
#list of fields from table
        #fieldLst =[430, 410, 162, 161]
        #fieldLst = setParam("First Field Value", "field_val_1", "GPString", "Optional", "")

        #sovi = in_gdb + "SoVI0610_RI"
        SocVul = setParam("SoVI", "sovi_poly", "", "", "")
        ...
        use_list = [useType1, useType2, useType3, useType4, useType5]
        #Bad values?
	...
	#Set the FieldsList to be filtered by the list from the feature dataset
        ...
        #defaults
        distance1.parameterDependencies = [RestorationSites.name]
    ...
    def updateParameters(self, params):
        ...
        if params[2].altered: #Conserve_Field
